document.addEventListener("DOMContentLoaded", function () {
    ...
    //     inputContainer.scrollIntoView(true, { behavior: 'smooth', block: "end" });
    // }
    ...
    let inputData = document.getElementById("inputDataEl");
    if (inputData) {
        // Find the image element within inputData
        let imageElement = inputData.querySelector("img");

        if (imageElement) {
            // Get the height and top position of the image
            let imageHeight = imageElement.clientHeight;
            let imageTop = imageElement.getBoundingClientRect().top;

            // Print the height and top position
            console.log("Image Height: " + imageHeight);
            console.log("Image Top Position: " + imageTop);
        }
    }
    // 333333
    // function appendInputData(el) {
    ...
    //     }
    //     inputContainer.appendChild(el);
    //     const middleOfContainer = inputContainer.getBoundingClientRect().top + (inputContainer.clientHeight/2.2);
    ...
    //     });
    //     }
    // window.addEventListener('load', appendInputData(el));
