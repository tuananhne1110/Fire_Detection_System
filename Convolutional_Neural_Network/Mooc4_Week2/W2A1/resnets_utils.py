...
def load_dataset():
    train_dataset = h5py.File('C:\\Users\\truon\\Downloads\\save_longtime\\LAB1_W1_M4_SE173200\\W2A1\\datasets\\train_signs.h5')
    # your train set features
    train_set_x_orig = np.array(train_dataset["train_set_x"][:])
    train_set_y_orig = np.array(
        train_dataset["train_set_y"][:])  # your train set labels

    test_dataset = h5py.File('C:\\Users\\truon\\Downloads\\save_longtime\\LAB1_W1_M4_SE173200\\W2A1\\datasets\\test_signs.h5')
